...
# docker run --init --rm --name player -e USER_PASSWORD="1234qwer" -e PROGRAM_PORT=":5000" -e DEBUG="true" -e WEBSITE_TITLE="Online Player" -e REDIS_ADDRESS="127.0.0.1:6379" -e REDIS_CHAT_EXP="60" -e USER_PASSWORD="123" -e JWT_SECRET="mvS9t48yq5Y32rionewt8yerlgn" -e JWT_EXPIRE_TIME="3" -p 5000:5000 player:latest
